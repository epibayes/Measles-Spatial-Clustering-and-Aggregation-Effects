...
motif_df <- function(x,y,z,q){
  ...
  prob_4 <- dplyr::mutate(prob_4, nonvax_percell =rmultinom(1, 2560, prob_4$cumulative_prob))
...
make_me_a_motif <- function(x,y,z,q){
  ...
  jpeg(paste0("/Users/ninamasters/Desktop/Dissertation/Aim 1 - Spatial Model/Clustering Motifs/Motifs 0.99/Motif",i,".jpg"), width = 550, height = 350) 
  plot(vax_motif_grid, col = colcode)
  title(paste("99% Vaccination: Clustering L1-L4: ", x[1], y[1], z[1], q[1]), line = 0.6)
